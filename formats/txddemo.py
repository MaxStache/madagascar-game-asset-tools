...
#clothes_dryer_tex = rwtxd.import_png("mod_assets/1290_Clothes Dryer.png", name="1290_Clothes Dryer")
#txd.textures.append(clothes_dryer_tex)

rwtxd.save(txd, "Levels/KingOfNY/2_TD_LEVEL FOLDER.txd")
