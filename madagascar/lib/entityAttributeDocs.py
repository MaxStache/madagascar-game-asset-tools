...
from madagascar.lib.entityAtributeDocs.CFXPartSpray import CFXPARTSPRAY_ATTRIBUTES
from madagascar.lib.entityAtributeDocs.CProtoActor import CPROTOACTOR_ATTRIBUTES
