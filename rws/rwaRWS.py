...
class AudioStream_2057_StreamHeader:
    ...
    def write(this, f, stamp):
        ...
        # stream_size
        _write_u32(buf, this.stream_size)
        # bit_depth
        ...
        # _unk_misc_offset
        _write_u32(buf, this._unk_misc_offset)
        # misc_data_size
...
class AudioStream_2057_Stream:
    ...
    def write(this, f, stamp):
        ...
        this.header_info.write(buf, stamp)
...
class AudioStream_2057:
    ...
    def present_streams(self):
        def _format_duration(seconds: float) -> str:
            ...
            return f"{minutes}:{seconds_part:02d}.{milliseconds:03d}"
        ...
        # Create Treeview
        tree = ttk.Treeview(
            root, columns=("Name", "SampleRate", "Length"), show="headings"
        )
        ...
        tree.column("SampleRate", width=150, anchor="center")
        tree.column("Length", width=120, anchor="center")

        for stream in self.file_data.subsongs:
            ...
            tree.insert(
                "",
                tk.END,
                values=(name, sample_rate, _format_duration(duration_seconds)),
            )
